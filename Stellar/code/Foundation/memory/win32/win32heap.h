...
public:
    ...
    static std::vector<Stats> GetAllHeapStats();
    /// validate all heaps
...
private:
    ...
    static Threading::CriticalSection*  m_pCriticalSection;
    static std::list<Win32Heap*>* m_pList;
    std::list<Win32Heap*>::iterator listIterator;
    #endif
};
