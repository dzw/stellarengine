...
public:
    ...
    /// float constructor
    explicit Variant(float rhs);
    /// bool constructor
    explicit Variant(bool rhs);
    /// float4 constructor
    explicit Variant(const Math::float4& v);
    /// matrix44 constructor
    explicit Variant(const Math::matrix44& m);
    /// string constructor
    explicit Variant(const Util::String& rhs);
    /// blob constructor
    explicit Variant(const Util::Blob& blob);
    /// guid constructor
    explicit Variant(const Util::Guid& guid);
    /// const char constructor
    explicit Variant(const char* chrPtr);
    /// object constructor
    explicit Variant(Core::RefCounted* ptr);
    /// int array constructor
    explicit Variant(const Util::Array<int>& rhs);
    /// float array constructor
    explicit Variant(const Util::Array<float>& rhs);
    /// bool array constructor
    explicit Variant(const Util::Array<bool>& rhs);
    /// float4 array constructor
    explicit Variant(const Util::Array<Math::float4>& rhs);
    /// matrix44 array constructor
    explicit Variant(const Util::Array<Math::matrix44>& rhs);
    /// string array constructor
    explicit Variant(const Util::Array<Util::String>& rhs);
    /// blob array constructor
    explicit Variant(const Util::Array<Util::Blob>& rhs);
    /// guid array constructor
    explicit Variant(const Util::Array<Util::Guid>& rhs);
...
Variant::Delete()
{
    if (String == this->type)
    {
        s_assert(this->string);
        s_delete(this->string);
        this->string = 0;
    }
    ...
    {
        s_assert(this->intArray);
        s_delete(this->intArray);
        this->intArray = 0;
    }
    else if (FloatArray == this->type)
    {
        s_assert(this->floatArray);
        s_delete(this->floatArray);
        this->floatArray = 0;
    }
    else if (BoolArray == this->type)
    {
        s_assert(this->boolArray);
        s_delete(this->boolArray);
        this->boolArray = 0;
    }
    else if (Float4Array == this->type)
    {
        s_assert(this->float4Array);
        s_delete(this->float4Array);
        this->float4Array = 0;
    }
    else if (Matrix44Array == this->type)
    {
        s_assert(this->matrix44Array);
        s_delete(this->matrix44Array);
        this->matrix44Array = 0;
    }
    else if (StringArray == this->type)
    {
        s_assert(this->stringArray);
        s_delete(this->stringArray);
        this->stringArray = 0;
    }
    else if (GuidArray == this->type)
    {
        s_assert(this->guidArray);
        s_delete(this->guidArray);
        this->guidArray = 0;
    }
    else if (BlobArray == this->type)
    {
        s_assert(this->blobArray);
        s_delete(this->blobArray);
        this->blobArray = 0;
    }
    this->type = Void;
}
...
Variant::Copy(const Variant& rhs)
{
    ...
    switch (rhs.type)
    {
        ...
        case Float4:
            ...
            break;
        case String:
            this->string = s_new(Util::String(*rhs.string));
            break;
        case Matrix44:
            this->m = s_new(Math::matrix44(*rhs.m));
            break;
        case Blob:
            this->blob = s_new(Util::Blob(*rhs.blob));
            break;
        case Guid:
            this->guid = s_new(Util::Guid(*rhs.guid));
            break;
        case Object:
            ...
            break;
        case IntArray:
            this->intArray = s_new(Util::Array<int>(*rhs.intArray));
            break;
        case FloatArray:
            this->floatArray = s_new(Util::Array<float>(*rhs.floatArray));
            break;
        case BoolArray:
            this->boolArray = s_new(Util::Array<bool>(*rhs.boolArray));
            break;
        case Float4Array:
            this->float4Array = s_new(Util::Array<Math::float4>(*rhs.float4Array));
            break;
        case Matrix44Array:
            this->matrix44Array = s_new(Util::Array<Math::matrix44>(*rhs.matrix44Array));
            break;
        case StringArray:
            this->stringArray = s_new(Util::Array<Util::String>(*rhs.stringArray));
            break;
        case GuidArray:
            this->guidArray = s_new(Util::Array<Util::Guid>(*rhs.guidArray));
            break;
        case BlobArray:
            this->blobArray = s_new(Util::Array<Util::Blob>(*rhs.blobArray));
            break;
        default:
            s_error("Variant::Copy(): invalid type!");
            break;
    }
}
...
Variant::Variant(const Util::String& rhs) :
    type(String)
{
    this->string = s_new(Util::String(rhs));
}
...
Variant::Variant(const char* chrPtr) :
    type(String)
{
    this->string = s_new(Util::String(chrPtr));
}
...
Variant::Variant(const Math::matrix44& rhs) :
    type(Matrix44)
{
    this->m = s_new(Math::matrix44(rhs));
}
...
Variant::Variant(const Util::Array<int>& rhs) :
    type(IntArray)
{
    this->intArray = s_new(Util::Array<int>(rhs));
}
...
Variant::Variant(const Util::Array<float>& rhs) :
    type(FloatArray)
{
    this->floatArray = s_new(Util::Array<float>(rhs));
}
...
Variant::Variant(const Util::Array<bool>& rhs) :
    type(BoolArray)
{
    this->boolArray = s_new(Util::Array<bool>(rhs));
}
...
Variant::Variant(const Util::Array<Math::float4>& rhs) :
    type(Float4Array)
{
    this->float4Array = s_new(Util::Array<Math::float4>(rhs));
}
...
Variant::Variant(const Util::Array<Math::matrix44>& rhs) :
    type(Matrix44Array)
{
    this->matrix44Array = s_new(Util::Array<Math::matrix44>(rhs));
}
...
Variant::Variant(const Util::Array<Util::String>& rhs) :
    type(StringArray)
{
    this->stringArray = s_new(Util::Array<Util::String>(rhs));
}
...
Variant::Variant(const Util::Array<Util::Guid>& rhs) :
    type(GuidArray)
{
    this->guidArray = s_new(Util::Array<Util::Guid>(rhs));
}
...
Variant::Variant(const Util::Array<Util::Blob>& rhs) :
    type(BlobArray)
{
    this->blobArray = s_new(Util::Array<Util::Blob>(rhs));
}
...
Variant::SetType(Type t)
{
    ...
    {
        case String:
            this->string = s_new(Util::String);
            break;
        case Matrix44:
            this->m = s_new(Math::matrix44);
            break;
        case Blob:
            this->blob = s_new(Util::Blob);
            break;
        case Guid:
            this->guid = s_new(Util::Guid);
            break;
        case Object:
            this->object = 0;
            break;
        case IntArray:
            this->intArray = s_new(Util::Array<int>);
            break;
        case FloatArray:
            this->floatArray = s_new(Util::Array<float>);
            break;
        case BoolArray:
            this->boolArray = s_new(Util::Array<bool>);
            break;
        case Float4Array:
            this->float4Array = s_new(Util::Array<Math::float4>);
            break;
        case Matrix44Array:
            this->matrix44Array = s_new(Util::Array<Math::matrix44>);
            break;
        case StringArray:
            this->stringArray = s_new(Util::Array<Util::String>);
            break;
        case GuidArray:
            this->guidArray = s_new(Util::Array<Util::Guid>);
            break;
        case BlobArray:
            this->blobArray = s_new(Util::Array<Util::Blob>);
            break;
    }
}
...
Variant::operator=(const Util::String& s)
{
    ...
    {
        this->Delete();
        this->string = s_new(Util::String(s));
    }
    this->type = String;
}
...
Variant::operator=(const Math::matrix44& val)
{
    ...
    {
        this->Delete();
        this->m = s_new(Math::matrix44(val));
    }
    this->type = Matrix44;
}
...
Variant::operator=(const Util::Array<int>& val)
{
    ...
    {
        this->Delete();
        this->intArray = s_new(Util::Array<int>(val));
    }
    this->type = IntArray;
}
...
Variant::operator=(const Util::Array<float>& val)
{
    ...
    {
        this->Delete();
        this->floatArray = s_new(Util::Array<float>(val));
    }
...
Variant::operator=(const Util::Array<bool>& val)
{
    ...
    {
        this->Delete();
        this->boolArray = s_new(Util::Array<bool>(val));
    }
    this->type = BoolArray;
}
...
Variant::operator=(const Util::Array<Math::float4>& val)
{
    ...
    {
        this->Delete();
        this->float4Array = s_new(Util::Array<Math::float4>(val));
    }
...
Variant::operator=(const Util::Array<Math::matrix44>& val)
{
    ...
    {
        this->Delete();
        this->matrix44Array = s_new(Util::Array<Math::matrix44>(val));
    }
...
Variant::operator=(const Util::Array<Util::String>& val)
{
    ...
    {
        this->Delete();
        this->stringArray = s_new(Util::Array<Util::String>(val));
    }
...
Variant::operator=(const Util::Array<Util::Guid>& val)
{
    ...
    {
        this->Delete();
        this->guidArray = s_new(Util::Array<Util::Guid>(val));
    }
    this->type = GuidArray;
}
...
Variant::operator=(const Util::Array<Util::Blob>& val)
{
    ...
    {
        this->Delete();
        this->blobArray = s_new(Util::Array<Util::Blob>(val));
    }
    this->type = BlobArray;
}
...
Variant::operator==(const Variant& rhs) const
{
    if (rhs.type == this->type)
    {
        switch (rhs.type)
        {
            ...
            default:
                s_error("Variant::operator==(): invalid variant type!");
                return false;
        }
    }
    return false;
...
{
    s_assert(Float4Array == this->type);
...
{
    s_assert(Matrix44Array == this->type);
...
{
    s_assert(StringArray == this->type);
...
Variant::TypeToString(Type t)
{
    switch (t)
    {
        ...
        default:
            s_error("Variant::TypeToString(): invalid type enum '%d'!", t);
            return 0;
    }
}
...
Variant::StringToType(const Util::String& str)
{
    ...
    {
        s_error("Variant::StringToType(): invalid type string '%s'!", str);
        return Void;
    }
}
