...
float2::length() const
{
    return s_sqrt(this->X * this->X + this->Y * this->Y);
}
...
float2::abs() const
{
    return float2(s_abs(this->X), s_abs(this->Y));
}
...
{
    return float2(s_max(v0.X, v1.X), s_max(v0.Y, v1.Y));
}
...
{
    return float2(s_min(v0.X, v1.X), s_min(v0.Y, v1.Y));
}
