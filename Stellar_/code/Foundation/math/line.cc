...
line::intersect(const line& l, point& pa, point& pb) const
{
    ...
    scalar d1343 = vector::dot3(p13, p43);
    scalar d4321 = vector::dot3(p43, p21);
    scalar d1321 = vector::dot3(p13, p21);
    scalar d4343 = vector::dot3(p43, p43);
    scalar d2121 = vector::dot3(p21, p21);

    scalar denom = d2121 * d4343 - d4321 * d4321;
    if (s_abs(denom) < EPS) return false;
