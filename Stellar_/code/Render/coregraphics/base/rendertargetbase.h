...
{
    s_assert(this->numColorBuffers < MaxNumColorBuffers);
...
{
    s_assert(colorBufferIndex < MaxNumColorBuffers);
...
{
    s_assert(!this->hasDepthStencilBuffer);
...
{
    s_assert(this->resolveTexture.isvalid());
