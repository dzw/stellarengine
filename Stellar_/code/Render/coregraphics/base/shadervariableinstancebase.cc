...
{
    s_assert(!this->shaderVariable.isvalid());
    s_assert(0 == this->arrayCount);
    s_assert(!this->arrayValues.IsValid());
    ...
    if (this->arrayCount > 0)
    {
        ...
        switch (this->value.GetType())
        {
            ...
            case Variant::Bool:
                ...
                break;
            default:
                s_error("ShaderVariable::Apply(): invalid data type for arrays!");
                break;
        }
    }
    else
    {
        ...
        switch (this->value.GetType())
        {
            ...
            case Variant::Object:
                ...
                break;
            default:
                s_error("ShaderVariable::Apply(): invalid data type for scalar!");
                break;
        }
    }
}
