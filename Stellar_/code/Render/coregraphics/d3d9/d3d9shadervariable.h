#pragma once
#ifndef DIRECT3D9_D3D9SHADERVARIABLE_H
#define DIRECT3D9_D3D9SHADERVARIABLE_H
//------------------------------------------------------------------------------
/**
...
*/
inline void
D3D9ShaderVariable::SetVector(const Math::float4& value)
{
...
*/
inline void
D3D9ShaderVariable::SetVectorArray(const Math::float4* values, SizeT count)
{
