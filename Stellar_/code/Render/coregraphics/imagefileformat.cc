...
ImageFileFormat::ToString(ImageFileFormat::Code c)
{
    switch (c)
    {
        ...
        case DDS:   return "dds";
        default:
            s_error("ImageFileFormat::ToString(): invalid image file format code!");
            return "";
    }
}
...
//        default:
//            s_error("ImageFileFormat::ToMediaType(): invalid image file format code!");
//            return IO::MediaType();
//    }
//}
