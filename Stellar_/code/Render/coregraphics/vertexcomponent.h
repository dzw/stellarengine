...
VertexComponent::SemanticNameToString(SemanticName n)
{
	...
	default:
		s_error("VertexComponent::SemanticNameToString(): invalid SemanticName code!");
		return "";
	}
}
...
VertexComponent::FormatToString(VertexComponent::Format f)
{
	...
	default:
		s_error("VertexComponent::FormatToString(): invalid Format code!");
		return "";
	}
}
...
VertexComponent::GetSignature() const
{
	...
	str.append(_itoa(this->semIndex, NULL, 10));
	return str;
}
