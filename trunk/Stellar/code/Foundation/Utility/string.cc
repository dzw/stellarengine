...
//{
//    s_assert(from <= this->strLen);
//    s_assert((from + numChars) <= this->strLen);
...
//{
//    s_assert(startIndex < this->strLen);
//    s_assert(s.IsValid());
//    IndexT i;
