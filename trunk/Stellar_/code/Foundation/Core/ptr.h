...
{
    s_assert2(this->ptr, "NULL pointer access in Ptr::operator->()!");
    return this->ptr;
}
...
{
    s_assert2(this->ptr, "NULL pointer access in Ptr::operator TYPE*()!");
    return this->ptr;
}
...
Ptr<TYPE>::downcast() const
{
    ...
    s_assert(OTHERTYPE::RTTI.IsDerivedFrom(TYPE::RTTI));
...
{
    // only allow casts to base classes
    s_assert(TYPE::RTTI.IsDerivedFrom(OTHERTYPE::RTTI));
    return *(Ptr<OTHERTYPE>*)this;
}
...
Ptr<TYPE>::get() const
{
    s_assert2(this->ptr, "NULL pointer access in Ptr::get()!");
    return this->ptr;
}
