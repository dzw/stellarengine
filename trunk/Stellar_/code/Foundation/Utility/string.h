...
//{
//    s_assert(newSize > (this->strLen + 1));
//    s_assert(newSize > this->heapBufferSize);
//    s_assert(0 != DataHeap);
//
//    // free old buffer
//    if (this->heapBuffer)
...
//        i++;
//    }
//    s_error("Invalid string value for bool!");
//    return false;
//}
//
////------------------------------------------------------------------------------
