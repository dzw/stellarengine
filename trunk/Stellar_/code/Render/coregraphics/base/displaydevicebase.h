#pragma once
#ifndef BASE_DISPLAYDEVICEBASE_H
#define BASE_DISPLAYDEVICEBASE_H
//------------------------------------------------------------------------------
/**
...
public:
    ...
    /// return true if the user asks application to quit (by Alt-F4)
...
*/
inline bool
DisplayDeviceBase::IsQuitRequested() const
{
