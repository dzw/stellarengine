#pragma once
#ifndef DIRECT3D9_D3D9TYPES_H
#define DIRECT3D9_D3D9TYPES_H
//------------------------------------------------------------------------------
/**
    @class Direct3D9::D3D9Types
...
D3D9Types::AsD3D9VertexDeclarationType(CoreGraphics::VertexComponent::Format f)
{
    ...
    switch (f)
    {
        ...
        default:                        
            s_error("D3D9Types::AsDirect3DVertexDeclarationType(): invalid input parameter!");
...
D3D9Types::AsD3D9VertexDeclarationUsage(CoreGraphics::VertexComponent::SemanticName n)
{
    ...
    switch (n)
    {
        ...
        default:
            s_error("D3D9Types::AsDirect3DVertexDeclarationUsage(): invalid input parameter!");
...
D3D9Types::AsD3D9PrimitiveType(CoreGraphics::PrimitiveTopology::Code t)
{
    ...
    switch (t)
    {
        ...
        default:
            s_error("D3D9Types::AsDirect3DPrimitiveType(): unsupported topology '%s'!",
                CoreGraphics::PrimitiveTopology::ToString(t).c_str());
...
D3D9Types::AsD3D9MultiSampleType(CoreGraphics::AntiAliasQuality::Code c)
{
    ...
    switch (c)
    {
        case AntiAliasQuality::None:    return D3DMULTISAMPLE_NONE;
        case AntiAliasQuality::Low:     return D3DMULTISAMPLE_2_SAMPLES;
        case AntiAliasQuality::Medium:  return D3DMULTISAMPLE_4_SAMPLES;
        case AntiAliasQuality::High:    return D3DMULTISAMPLE_8_SAMPLES;
        default:
            s_error("D3D9Types::AsD3D9MultiSampleType(): unsupported AntiAliasQuality!");
...
D3D9Types::AsD3DXImageFileFormat(CoreGraphics::ImageFileFormat::Code c)
{
    ...
    switch (c)
    {
        ...
        default:
            s_error("D3D9Types::AsD3DXImageFileFormat(): unsupported ImageFileFormat!");
            return D3DXIFF_BMP;
    }
}
