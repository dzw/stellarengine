...
public:
	...
	enum MapType
	{
		MapRead,                // gain read access, must be UsageStaging and AccessRead
		MapWrite,               // gain write access, must be UsageStaging and AccessWrite
		MapReadWrite,           // gain read/write access, must be UsageStaging and AccessReadWrite
